...
大学・大学院の専門は分散並列処理。大学院修了以降もプライベートの時間や副業などで研究開発活動を継続。2021/09からはトヨタ自動車株式会社にてデータベース・ストリーム処理・秘密計算などの研究や新規プラットフォーム事業の企画開発。
...
[CTFtimeアカウント](https://ctftime.org/team/263940)
