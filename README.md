...
直近の業務では、IoTデバイスへのソフトウェア遠隔インストールを実現するための研究開発を行っている。

以下、各種特定技術の習熟度を記載。

- プログラミング言語
    - **Rust**: 習熟度高
        - [『Rustではじめるデータ構造とアルゴリズム』をブログで連載中](https://laysakura.github.io/2019/12/22/rust-DataStructures-Algorithm-BinaryTree/)
    - **Ruby (Rails)**: 習熟度高
    - **Scala (Finagle)**: 習熟度高
    - **C**: 習熟度高
    - **Python**: 習熟度中
...
### [Idein株式会社](https://idein.jp/) (2020/03 - )
