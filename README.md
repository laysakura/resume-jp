...
公開職務経歴書です。本業のほか、セキュリティ関係のご支援も行っております（[詳細]([https://github.com/laysakura/resume-jp/blob/master/security-development-lab.md](https://github.com/laysakura/Security-Development-Lab))）。
...
- [PWS Cup 2024](https://www.iwsec.org/pws/2024/cup24.html) ベストアタック賞 / 総合7位 (2024)
  - KAT-TUNE チームとして出場 <sub>(私の貢献は少ない...)</sub>
...
- 差分プライバシーデータプラットフォーム研究（セキュリティ部分主担当）
...
2018/10より経営会議に参加し、執行役員制度が設立された2019/05より兼執行役員。
